<?php
/*
Plugin Name: Responsive Modern Slider
...
if (!class_exists("IDP_Slider_lite")) {
    ...
    class IDP_Slider_lite {
        ...
        function __construct() {
            ...
            include "inc/slider-set.php";
            include "inc/fields/fields-slider.php";
            include "inc/ButtonShortcodes.php";
            include "inc/shortcodes.php";
            include "inc/other_functions.php";
            load_plugin_textdomain('idp-slider', false, basename(dirname(__FILE__)) . '/language');
            load_plugin_textdomain('cmb2', false, basename(dirname(__FILE__)) . '/fields/cmb2/languages');
            // For User - add files .js and .css
            add_action("wp_enqueue_scripts", array(&$this, "wppg_user_script"));
            add_action("wp_enqueue_scripts", array(&$this, "wppg_user_stylesheet"));
        }
        ...
        function idp_slider_options_page() {
            ...
            <div class='container-fluid'>
                <div class='row'>";
            $adm = cmb2_get_option('idp-slider-lite-options', true);
            ...
            ?>
            <link rel="stylesheet" href="<?php echo plugins_url(); ?>/responsive-modern-slider/user_css/tables.css">
            ...
            <div class="col-sm-6 col-md-6">
                <caption><?php _e('It looks like the slider when using shortcode', 'idp-slider'); ?> <span class="img-thumbnail">[Modern-lite id="##"]</span></caption>
                <p><img src="<?php echo plugins_url(); ?>/responsive-modern-slider/images/modern.jpg" class="img-responsive"/></p>
            </div>
        ...
        function wppg_user_script() {
            ...
            if ($jquery_act == 'on') {
                ...
                wp_register_script('jquery', "//ajax.googleapis.com/ajax/libs/jquery/1/jquery.min.js", false, false, false);
                wp_enqueue_script('jquery');
            }
            if ($bootstrap_act == 'on') {
                wp_register_script('wppg_bootstrap_min_js', plugins_url('/user_js/bootstrap.min.js', __FILE__), array( 'jquery' ), false, true);
                wp_enqueue_script("wppg_bootstrap_min_js");
            }
            wp_register_script('wppg_npm_js', plugins_url('/user_js/npm.js', __FILE__), array( 'jquery' ), false, true);
