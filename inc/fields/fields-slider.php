...
class IDP_Slider_lite_Admin extends IDP_Slider_lite {
	...
	public function add_options_page() {
		$this->options_page = add_submenu_page('responsive-modern-slider.php', __('IDP Slider setting', 'idp-slider' ),  __('IDP Slider setting', 'idp-slider' ), 'manage_options', $this->key, array( $this, 'admin_page_display' ) );
